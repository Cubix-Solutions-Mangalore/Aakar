          ...
          <div class="accordion-item col-sm-4 col-lg-3 border-0">
            ...
            <div class="accordion-collapse collapse d-sm-block" id="quickLinks" aria-labelledby="quickLinksHeading" data-bs-parent="#footerLinks">
              <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                ...
                <li class="pt-1">
                  <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Events &amp; meetups</a>
                </li>
                <li class="pt-1">
          ...
          <div class="accordion-item col-sm-3 col-lg-2 col-xxl-3 border-0">
            ...
            <div class="accordion-collapse collapse d-sm-block" id="profileLinks" aria-labelledby="profileLinksHeading" data-bs-parent="#footerLinks">
              <ul class="nav flex-column gap-2 pt-sm-1 pt-lg-2 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                ...
                <li class="pt-1">
                  <a class="nav-link hover-effect-underline d-inline text-body fw-normal p-0" href="#!">Taxes &amp; fees</a>
                </li>
                <li class="pt-1">
          ...
          <div class="col-lg-4 col-xxl-3 pt-4 pt-md-5 pt-lg-0 mt-3 mt-md-0">
            ...
            <form class="d-flex flex-column flex-sm-row flex-lg-column gap-3 needs-validation" novalidate="">
              <div class="position-relative w-100">
                ...
                <input type="email" class="form-control form-icon-start text-start rounded-pill" placeholder="Your email" aria-label="Email input" required="">
              </div>
        ...
        <div class="border-top pt-2 pb-md-2">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-5 col-xl-4 d-lg-flex justify-content-end">
              <p class="text-body-secondary fs-sm text-center text-lg-start mb-0">© All rights reserved. Made by <a class="text-body fw-medium text-decoration-none hover-effect-underline" href="https://createx.studio/" target="_blank" rel="noreferrer">Createx Studio</a></p>
            </div>
          </div>
        </div>
      </div>
