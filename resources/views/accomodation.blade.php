        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 g-4 mb-n2">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link"
                                href="single-entry-city-guide.html">Barcelona Business Hotel</a>
                        </h3>
                    </div>
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.html">Big
                                Tree Cottage</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.html">Grand
                                Resort &amp; Spa</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link"
                                href="single-entry-city-guide.html">Serenity Hotel</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
                        <div class="d-flex align-items-center gap-1">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.html">Merry
                                Berry Motel</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.html">Repose
                                Hotel</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link"
                                href="single-entry-city-guide.html">Tranquil Hotel</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
                        <div class="d-flex align-items-center gap-1">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.html">Soothe
                                &amp; Stay</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.html">Best
                                Nest Apartment</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.html">Pine
                                Cottage</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link"
                                href="single-entry-city-guide.html">Greenpoint Boutique Hotel</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
                        <div class="d-flex align-items-center gap-1">
            ...
            <div class="col pb-2">
                <article class="card h-100 hover-effect-scale hover-effect-opacity bg-transparent border-0">
                    ...
                    <div class="card-body pt-3 pb-2 px-0">
                        <h3 class="h5 mb-0">
                            <a class="hover-effect-underline stretched-link" href="single-entry-city-guide.html">Crystal
                                Studio Apartment</a>
                        </h3>
                    </div>
                    <div class="card-footer d-flex align-items-center gap-3 bg-transparent border-0 p-0">
